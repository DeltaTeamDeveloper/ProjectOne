        ...
        <>
            <div className={styles.comprehensive}>
                ...
                <Container>
                    ...
                    <Row>
                        <Col xl={12}>
                            <h2 className="fw700 font40 text-white font-f t-center mb-3">The <Link className='textdocationnone text-white hover' href="/book-publishing-services/">Book Publishing Services</Link> We Provide!</h2>
                                    ...
                                    <div className={styles.flipcard}>
                                        <div className={styles.flipcardinner}>
                                            <div className={`${styles.flipcardfront}  ${styles.flipcardfront1}`}>
                                                <Image loading="lazy" width={80} height={80} className='img-fluid' src={item.image} alt="Texas_Book_Publishing"></Image>
                                                <h3>{item.subTitle}</h3>
                                            </div>
