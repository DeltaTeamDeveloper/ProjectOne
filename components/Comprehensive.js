        ...
        <>
            <div className={styles.comprehensive}>
                ...
                <Container>
                    ...
                    <Row>
                        <Col xl={12}>
                            <h2 className="fw700 color-blue font40 font-f t-center mb-5">Our Comprehensive Services Include</h2>
                        </Col>
                    </Row>
                                    ...
                                    <div className={styles.flipcard}>
                                        <div className={styles.flipcardinner}>
                                            <div className={`${styles.flipcardfront}  ${styles.flipcardfront1}`}>
                                                <Image loading="lazy" className='img-fluid' src={item.image} alt="Texas_Book_Publishing"></Image>
                                                <h3>{item.subTitle}</h3>
                                            </div>
