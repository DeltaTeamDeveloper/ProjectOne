...
const blogWritingService = () => {
  ...
  const newSpan = <h1 className='font50 fw700 text-black font-f hero-span'><Link className='textdocationnone color-blue hover' href="/blog-writing-service/">Blog Writing Services</Link> to Help You Come Closer <br /> To Your Refined Prospects!</h1>;
