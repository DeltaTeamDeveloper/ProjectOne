...
const bookCoverDesignServices = () => {
  ...
  const newSpan = <h1 className='font50 fw700 text-black font-f hero-span'><Link className='textdocationnone color-blue hover' href="/book-cover-design-services/">Book Cover Design Services</Link> To Help Your Manuscript <br /> The Best Selling Book Of All Times!</h1>;
