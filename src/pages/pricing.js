...
const Pricing = () => {
  ...
  const exprtSpan = <span className='fw500 font40 text-black font-f t-center font-f mb-4'><span className='text-white fw700'>Texas Book Publishing</span> Is waiting for you to Ask for a <span className='text-white fw700'>Professional Ghostwriter</span></span>;
