    ...
    return (
        ...
        <>
            ...
            <div className={styles.banner}>
                  ...
                  <h1 className='color-black font70 t-center linhight mb-4'>Our <br></br> Editing</h1>
                ...
                <Container className={styles.rate1}>
                    ...
                    <Row className='mt-5'>
                        <Col md={3}>
                            <Image src={bookpublishing1} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookpublishing2} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookpublishing3} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookpublishing4} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                    </Row>
                    ...
                    <Row className='mt-5'>
                        <Col md={3}>
                            <Image src={bookwriting1} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookwriting2} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookwriting3} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookwriting4} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                    </Row>
                    ...
                    <Row className='mt-5'>
                        <Col md={3}>
                            <Image src={bookediting1} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookediting2} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookediting3} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookediting4} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                    </Row>
                    ...
                    <Row className='mt-5'>
                        <Col md={3}>
                            <Image src={bookmarketing1} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookmarketing2} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookmarketing3} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                        <Col md={3}>
                            <Image src={bookmarketing4} className='img-fluid' alt='Texas Book Publishing'></Image>
                        </Col>
                    </Row>
