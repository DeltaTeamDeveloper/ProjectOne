...
const Audiobookrecordingservices = () => {
  ...
  const whybookpublishingdata = [

    {
      ...
      text: 'As an author, you want your audiobook to be perfect. You want every word to be clear, and you want the overall performance to be engaging. This is why so many authors choose Texas Book Publishing’s audiobook recording service. We are the best in the industry for a reason. Our team of professional voice actors has years of experience performing audiobooks. They know how to bring a book to life, and they know how to make sure every word is clear. Plus, they’re just plain fun to listen to! ',
      col6: '6',
    },
    {
  ...
  return (
    <>
      ...
      {/* Aspiring */}
      <Aspiring
        title='Dive into The New Era of Audiobooks with Texas Book Publishing’s High-Quality Audiobook Recording Services Today!'
